...
// import 'innerWidget/boutique_chat_card.dart';
//
// class BoutiqueChatHistoryScreen extends StatelessWidget {
//   const BoutiqueChatHistoryScreen({super.key});
//
//   @override
...
//                 return   BoutiqueChatCard(
//                   userImage:"https://images.unsplash.com/photo-1513094735237-8f2714d57c13?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHNob3BwaW5nfGVufDB8fDB8fHww",
//                   lastMsg: 'Hello',
//                   userName: 'Modern Nice',
//                 );
//               })
//         ],
//       ),
...
class BoutiqueChatHistoryScreen extends StatefulWidget {
  BoutiqueChatHistoryScreen({super.key});

  @override
  State<BoutiqueChatHistoryScreen> createState() => _BoutiqueChatHistoryScreenState();
}

class _BoutiqueChatHistoryScreenState extends State<BoutiqueChatHistoryScreen> {
                ...
                if (index >=
                  ...
                  return GestureDetector(
                    child: Padding(
                      ...
                      child: ListTile(
                          onTap: () {
                            Get.toNamed(AppRoutes.boutiqueChatScreen,arguments: data.chatId,
                                parameters: {
