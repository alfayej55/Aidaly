...
class BoutiqueSetLocationScreen extends StatelessWidget {
   BoutiqueSetLocationScreen({super.key});
           ...
           Expanded(
             child: Column(
               ...
               children: [
                 ...
                 CustomButton(
                   onTap: (){
                     signUpCtrl.getCurrentLocation().then((value) => signUpCtrl.boutiqueSetLocation());
                   },
                   height: 58.h,
                   width: 342.w,
