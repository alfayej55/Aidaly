...
class DriverTermsAndUseScreen extends StatefulWidget {
  DriverTermsAndUseScreen({super.key});

  @override
  State<DriverTermsAndUseScreen> createState() => _DriverTermsAndUseScreenState();
}

class _DriverTermsAndUseScreenState extends State<DriverTermsAndUseScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(()=>_privecyCtrl.privecyLoading.value
          ? CustomPageLoading()
