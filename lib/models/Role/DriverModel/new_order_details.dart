...
DriverNewOrderDetailsModel driverNewOrderDetailsModelFromJson(String str) => DriverNewOrderDetailsModel.fromJson(json.decode(str));

String driverNewOrderDetailsModelToJson(DriverNewOrderDetailsModel data) => json.encode(data.toJson());

class DriverNewOrderDetailsModel {
  String? status;
  int? statusCode;
  String? message;
  Data? data;
  ...
  factory DriverNewOrderDetailsModel.fromJson(Map<String, dynamic> json) => DriverNewOrderDetailsModel(
    status: json["status"],
