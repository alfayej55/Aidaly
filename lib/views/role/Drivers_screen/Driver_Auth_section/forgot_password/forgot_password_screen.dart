import 'package:aidaly/controllers/Role/Driver_Controllar/auth_controllar/driver_signin_controllar.dart';
...
class DriverForgotPasswortScreen extends StatelessWidget {
  DriverForgotPasswortScreen({super.key});
      ...
      body: Padding(
        ...
        child: Obx(() => Column(
          ...
          children: [
            ...
            CustomTextField(
              controller:signInCtrl.forgotEmailCtrl ,
