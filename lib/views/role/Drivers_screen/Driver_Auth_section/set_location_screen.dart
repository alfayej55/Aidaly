...
class DriverSetLocationScreen extends StatelessWidget {
   DriverSetLocationScreen({super.key});

  DriverSignUpControllar signUoCtrl=Get.put(DriverSignUpControllar());
