...
//
//
// class BoutiqueChatInboxScreen extends StatelessWidget {
//    BoutiqueChatInboxScreen({super.key});
//
...
//                       children: [
//                         Text('Heest Munal',
//                           style: AppStyles.customSize(size: 22,fontWeight: FontWeight.w500),
//                         ),
//                         Text('Driver',style: AppStyles.h6(color: Get.theme.secondaryHeaderColor),),
//                       ],
//                     )
//                   ],
//                 ),
...
//                            hintText: AppString.yourmessage.tr,
//                            controller: msgCtrl,
//                          suffixIcon: Padding(
...
//                      ),
//                      child: Center(child: SvgPicture.asset(AppIcons.sentIcon,height: 24.h,width: 24,),),
//                    )
//                  ],
//                ),
//              ),
...
class DriverChatInboxScreen extends StatefulWidget {
  DriverChatInboxScreen({super.key});

  @override
  State<DriverChatInboxScreen> createState() => _DriverChatInboxScreenState();
}

class _DriverChatInboxScreenState extends State<DriverChatInboxScreen> {
