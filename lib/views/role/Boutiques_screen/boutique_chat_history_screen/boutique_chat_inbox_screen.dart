...
class BoutiqueChatInboxScreen extends StatefulWidget {
  BoutiqueChatInboxScreen({super.key});

  @override
  State<BoutiqueChatInboxScreen> createState() => _BoutiqueChatInboxScreenState();
}

class _BoutiqueChatInboxScreenState extends State<BoutiqueChatInboxScreen> {
