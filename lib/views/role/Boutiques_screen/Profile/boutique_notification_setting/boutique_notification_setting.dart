...
class BoutiqueNotificationSettingScreen extends StatefulWidget {
  const BoutiqueNotificationSettingScreen({super.key});

  @override
  State<BoutiqueNotificationSettingScreen> createState() => _BoutiqueNotificationSettingScreenState();
}

class _BoutiqueNotificationSettingScreenState extends State<BoutiqueNotificationSettingScreen> {
