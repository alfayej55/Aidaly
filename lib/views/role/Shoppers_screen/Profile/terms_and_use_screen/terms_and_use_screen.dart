...
class TermsAndUseScreen extends StatefulWidget {
   TermsAndUseScreen({super.key});

  @override
  State<TermsAndUseScreen> createState() => _TermsAndUseScreenState();
}

class _TermsAndUseScreenState extends State<TermsAndUseScreen> {
