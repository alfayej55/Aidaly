import 'package:aidaly/controllers/Role/Driver_Controllar/auth_controllar/driver_signup_controllar.dart';
...
class DriverVerificationScreen extends StatelessWidget {
  DriverVerificationScreen({super.key});
  TextEditingController pinCodeCtrl = TextEditingController();

  final verifaiEmail=Get.arguments;
  
  DriverSignUpControllar signInCtrl=Get.put(DriverSignUpControllar());
        ...
        child: Column(
            ...
            children: [
              ...
              signInCtrl.verificationLoading.value?CustomPageLoading():  CustomButton(onTap: (){
                 signInCtrl.driverOtpVerification(verifaiEmail, pinCodeCtrl.text);
