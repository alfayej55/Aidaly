...
class DriverForgotOtpScreen extends StatelessWidget {
  DriverForgotOtpScreen({super.key});
        ...
        child: Column(
            ...
            children: [
              ...
              signInCtrl.verificationLoading.value?CustomPageLoading(): CustomButton(onTap: (){
                signInCtrl.driverForgotOtpVerification(verifaiEmail,pinCodeCtrl.text);
